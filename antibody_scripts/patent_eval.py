...
def raw_mouse_t20():
    lab_mouse_t20_dirpath = '/sample_t20_mou_score.csv'
...
def exp_human_t20():
    lab_exper_t20_dirpath = '/sample_t20_score.csv'
...
def main(root_path):
    ...
    logger.info('Sample_fpath: {}'.format(root_path))
    ...
    lab_exper_dirpath = 'filter_humanized_oasis.xlsx'
    ...
    lab_human_fpath = '/humanization_pair_data_filter.csv'
